...
public class GerenciamentoEstoqueApplication {
	...
	CommandLineRunner carregarDadosIniciais(FuncionarioAutenticadoRepository funcionarioAutenticadoRepository,
		...
		return args -> {
			...
			criarFuncionarioAutorizado(funcionarioAutenticadoRepository, "Ana Souza", "1001");
			criarFuncionarioAutorizado(funcionarioAutenticadoRepository, "Carlos Lima", "1002");
			criarFuncionarioAutorizado(funcionarioAutenticadoRepository, "Marina Alves", "1003");
